...
public class CreateToken {
    ...
    public static String sign(String stringToSign, String accessKeySecret) {
        try {
            ...
            String signBase64 = Base64.encodeToString(signData,Base64.NO_WRAP);
    ...
    public static String test() {
        String accessKeyId = "LTAI4GFKYk1jwXsvsraLVKh1";
        String accessKeySecret = "puWdvzfpcKNnINtW5bQZc5QC8G3O0O";
